...
static const float LIGHT_POWER       = 0.4f;
...
FacilityLight1::FacilityLight1( omi::Transform* baseTransform, bool flicker )
    :
    Decor             ( baseTransform ),
    m_flicker         ( flicker ),
    m_lightOn         ( true ),
...
void FacilityLight1::init()
{
    ...
    m_paneMesh = omi::ResourceManager::getMesh(
            "facility_light_1_pane", "", m_baseTransform );
    ...
    omi::Mesh* fittingMesh = omi::ResourceManager::getMesh(
            "facility_light_1_fitting", "", m_baseTransform );
